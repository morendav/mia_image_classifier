    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        attack_results = mia.run_attacks(
            ...
            attack_types=(
                ...
                # AttackType.LOGISTIC_REGRESSION,   # for demonstration will only use threshold type attacks
            ),
...
if __name__ == '__main__':
    ...
    # Experiment: Compare experiment 1 dense model 10 class dataset, against the same model but for a 4class dataset
    # (Deprecated) Experiment: Compare Experiment 1 models trained on a 4 class dataset (4 first classes from 10class dataset)
    # build comparison between classes in training dataset, model characteristics (depth, type) are constants
    # NOTE: previously, this copmarison was between model types (3layer dense, 3layer conv2d) for a 4-class dataset
